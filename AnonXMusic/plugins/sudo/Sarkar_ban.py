...
from AnonXMusic.utils.Sarkar_ban import admin_filter
...
@app.on_message(filters.command(["jjj","hhh"], prefixes=["hhggV", "Phhh"]) & admin_filter)
async def restriction_app(app :app, message):
    reply = message.reply_to_message
    chat_id = message.chat.id
    if len(message.text) < 2:
        return await message.reply(random.choice(Sarkar_text))
