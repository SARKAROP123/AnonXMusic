...
@app.on_message(filters.command(["tagall", "all", "tagmember", "stag", "hftag", "bstag", "eftag", "tag", "etag", "tag", "tag" ], prefixes=["/", "@", "#"]))
